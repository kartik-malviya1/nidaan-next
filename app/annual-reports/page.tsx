        ...
        <div className="max-w-7xl mx-auto">
          ...
          {isLoading ? (
            ...
            <div className="space-y-12">
              <div className="h-[380px] bg-slate-200 animate-pulse rounded-3xl" />
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              className="text-center py-20 px-6 bg-white border border-slate-200 rounded-3xl max-w-xl mx-auto shadow-sm"
            >
              ...
              <div className="mt-6 pt-5 border-t border-slate-100 text-xs text-slate-400">
                For urgent inquiries, email us at <a href="mailto:nirtnidaan@gmail.com" className="text-amber-600 hover:underline">nirtnidaan@gmail.com</a>
              </div>
            </motion.div>
          ) : (
            ...
            <>
              ...
              {featured && (
                <motion.div
                  ...
                  className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-20 bg-black/95 text-white rounded-3xl overflow-hidden shadow-xl"
                >
                  {/* Cover image */}
                  ...
                  <div className="flex flex-col justify-center gap-6 p-8 lg:p-10">
                    <div>
                      <div className="text-amber-400 text-sm font-medium uppercase tracking-widest mb-2">{featured.year}</div>
                      <h3 className="text-2xl md:text-4xl font-bold mb-2 tracking-tight text-white">{featured.title}</h3>
                    </div>
                        ...
                        {featured.highlights.map((h, i) => {
                          ...
                          return (
                            <div key={h} className="flex items-center gap-3 bg-white/10 rounded-xl px-4 py-3 border border-white/5">
                              ...
                              <span className="text-sm text-white/90 font-medium leading-tight">{h}</span>
                            </div>
                          );
                        })}
                      </div>
                    ...
                    <div className="flex gap-3 mt-2">
                      <a 
                        ...
                        download
                        className="flex items-center gap-2 bg-amber-500 text-slate-900 px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-amber-400 transition-colors"
                      >
                      ...
                      <a 
                        ...
                        className="flex items-center gap-2 border border-white/20 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-white/10 transition-colors"
                      >
              ...
              {rest.length > 0 && (
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-6">Previous Reports</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
                    {rest.map((report, i) => (
                      <motion.div
                        ...
                        className="group bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md hover:border-amber-200 transition-all flex flex-col justify-between"
                      >
                        <div>
                          {/* Cover thumbnail */}
                          ...
                          <div className="p-4">
                            <div className="flex items-start gap-2 mb-3">
                              ...
                              <div>
                                <div className="text-xs font-bold leading-snug line-clamp-2">{report.title}</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="p-4 pt-0">
                          <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 text-xs font-semibold text-slate-800 hover:text-amber-500 transition-colors group/link"
                          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-16 text-center border-t border-slate-200 pt-8"
          >
            <p className="text-xs text-slate-500 max-w-2xl mx-auto leading-relaxed">
              ...
              <a href="mailto:nirtnidaan@gmail.com" className="text-slate-900 font-medium underline underline-offset-2 hover:text-amber-500 transition-colors">
