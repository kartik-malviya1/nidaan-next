...
export function SuccessStoryCard({
  ...
  return (
    <div className="relative w-full h-full  mx-auto bg-[#FDFBF7] p-8 sm:p-10 pb-12 rounded-3xl shadow-sm border border-gray-100 font-sans pointer-events-none flex flex-col items-center">
      ...
      <svg
        className="absolute top-6 left-6 sm:w-10 sm:h-10 w-6 h-6 text-[#46D2D2]"
        viewBox="0 0 50 50"
        fill="none"
        stroke="currentColor"
        strokeWidth="3"
      ...
      <svg
        className="absolute top-6 right-5 sm:w-10 sm:h-10 w-6 h-6 text-[#46D2D2]"
        viewBox="0 0 50 50"
        fill="none"
        stroke="currentColor"
        strokeWidth="3"
      ...
      <svg
        className="absolute top-44 right-0 w-16 h-40 z-0"
        viewBox="0 0 50 100"
      >
        <path
          d="M25 10 L25 30 M15 15 L35 25 M15 25 L35 15"
          stroke="#FFB067"
          strokeWidth="4"
          strokeLinecap="round"
        />
        <path
          d="M20 50 L40 45 M25 70 L45 65 M15 90 L35 95"
          stroke="#46D2D2"
          strokeWidth="6"
          strokeLinecap="round"
        />
      ...
      <div className="relative w-full grow flex flex-col">
        ...
        <svg
          className="absolute top-0 -left-6 sm:-left-8 w-20 h-20 sm:w-20 sm:h-20 text-[#46D2D2] z-0"
          viewBox="0 0 100 100"
          stroke="currentColor"
          strokeWidth="8"
          strokeLinecap="round"
        ...
        <svg
          className="absolute -bottom-6 -right-4 sm:-right-6 w-20 h-20 sm:w-20 sm:h-24 text-[#46D2D2] z-0"
          viewBox="0 0 100 100"
          stroke="currentColor"
          strokeWidth="8"
          strokeLinecap="round"
...
const results = [
  {
    ...
    imageSrc: "/success-img.png",
    description:
      "Congratulations to all our NIOS Class 10th and 12th students for achieving outstanding results.",
  },
];
const storiesData = [
  {
    ...
    imageSrc: "/Steven.png",
    description:
      "Congratulations for securing admission in Queen Mary Higher Secondary School Bhopal successfully completed his session and now is in class 2.",
  },
  {
    id: 2,
    ...
    imageSrc: "/Parth.png",
    description:
      "Congratulations on your admission in Kendriya Vidhyalay 3 Bhopal. Parth is now a Student of Class 2",
  },
  {
    id: 3,
    name: "Shivansh Yadav",
    ...
    description:
      "Congradulations For Securing Admission in Sheel Public School Higher Secondary School (Nursery).",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    imageSrc: "/Saini.png",
    description:
      "Congradulations For Securing Admission in Kiddies Paradise For Session 2025-2026, Kendriya Vidhyalay Sagar For 2026-2027.",
  },
  {
    id: 6,
    name: "Academic Excellence",
