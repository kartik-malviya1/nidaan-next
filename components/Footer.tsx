        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-sm leading-relaxed mb-6 max-w-xs">
              {" "}
              Where Every Potential Unfolds — Together We Strive, Together We
              Thrive.{" "}
            </p>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                <MapPin className="text-[#ffcc00] shrink-0 mt-0.5" size={16} />
                <div>
                  {" "}
      ...
      <div className="border-t border-[#FFCC00]/20 bg-black">
        <div className="section-container py-5 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-white/70">
            ...
            Nidaan Sewa Samiti. All rights reserved.{" "}
          </p>
